...
<p align="center">
  <a href="https://github.com/Saganaki22/GNM-Studio/releases"><img src="https://img.shields.io/badge/release-v1.3.0-54ddb2" alt="Release v1.3.0"></a>
...
GNM Studio `1.3.0` combines Google GNM Head v3, the MIT FaceCap 52 avatar, MediaPipe Face Landmarker,
...
| Package | Use it when |
| --- | --- |
| [Standard portable ZIP](https://github.com/Saganaki22/GNM-Studio/releases/download/v1.3.0/GNM-Studio-1.3.0-Windows-x64-Portable.zip) | Recommended. Best compatibility with antivirus and code signing. |
| [Portable UPX ZIP](https://github.com/Saganaki22/GNM-Studio/releases/download/v1.3.0/GNM-Studio-1.3.0-Windows-x64-Portable-UPX.zip) | Smaller packed executable. Use if your antivirus accepts UPX-packed apps. |
...
**File → Import → glTF 2.0**. Alembic export is not part of `1.3.0`.
